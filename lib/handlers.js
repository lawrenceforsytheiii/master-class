                    ...
                    _data.delete('checks', checkId, (err) => {
                      if (err) {
                        ...
                        if (checksDeleted == checksToDelete) {
                          ...
                          callback(500, {'Error': 'Errors encountered while attempting to delete all of the user\'s checks. All of the checks may not have been deleted successfully'});
                        }
                      }
                    });
                  });
        ...
        if (hashedPassword == userData.hashedPassword) {
          ...
          _data.create('tokens', tokenId, tokenObject, (err) => {
            if (!err) {
              ...
              callback(500, {'Erorr' : 'Could not create the new token'});
            }
          });
        } else {
